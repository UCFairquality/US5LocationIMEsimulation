...
loopYear = 5;  
outFileName = 'InputMeta_KTUS_2024.mat';
...
for dNum = 1:runDayN
    ...
    for L = 1:nZ
        ...
        lines{end+1} = sprintf('   SURFDATA  23160  %d  Tucson', y);
        lines{end+1} = sprintf('   UAIRDATA  23160  %d  Tucson', y);
...
inMetaFile = fullfile(inpFolder, outFileName);
